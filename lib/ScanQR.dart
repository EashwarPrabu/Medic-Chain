...
class _ScanQRState extends State<ScanQR> {
  ...
  void initState() {
    super.initState();
//    blockChain.setPatientDetails("1", "Watson", "27", "Male");
//    blockChain.setMedicine("5", "Dolo 600", "1-1-1");
//    blockChain.setRecord("1", "Throat Infection", "07-04-2021");
    blockChain.getPatientDetails("1");
//    blockChain.getMedicines("1");
//    blockChain.getRecords("1");
  }
